...
object ServiceLocator {
    ...
    private var hotelRepository: HotelRepository? = null
    ...
    private var userTodoRepository: UserTodoRepository? = null
    ...
    fun provideTradeLedgerRepository(context: Context): TradeLedgerRepository =
        tradeLedgerRepository ?: synchronized(this) {
    ...
    fun provideHotelRepository(context: Context): HotelRepository =
        hotelRepository ?: synchronized(this) {
            hotelRepository ?: HotelRepository(
                api = provideReportApiService(context),
            ).also { hotelRepository = it }
        }

    fun provideDashboardPreferencesRepository(context: Context): DashboardPreferencesRepository =
        dashboardPreferencesRepository ?: synchronized(this) {
            dashboardPreferencesRepository ?: DashboardPreferencesRepository(
                context = context.applicationContext,
                api = provideReportApiService(context),
            ).also { dashboardPreferencesRepository = it }
        }
    ...
    fun provideVoucherRegisterRepository(context: Context): VoucherRegisterRepository =
        voucherRegisterRepository ?: synchronized(this) {
            voucherRegisterRepository ?: VoucherRegisterRepository(
                api = provideReportApiService(context),
            ).also { voucherRegisterRepository = it }
        }

    fun provideCashBankBookRepository(context: Context): CashBankBookRepository =
        cashBankBookRepository ?: synchronized(this) {
    ...
    fun provideMenuPreferencesRepository(context: Context): MenuPreferencesRepository =
        menuPreferencesRepository ?: synchronized(this) {
            menuPreferencesRepository ?: MenuPreferencesRepository(
                context = context.applicationContext,
                api = provideReportApiService(context),
            ).also { menuPreferencesRepository = it }
        }
    ...
    fun provideBankOpeningRepository(context: Context): BankOpeningRepository =
        bankOpeningRepository ?: synchronized(this) {
    ...
    fun provideUserTodoRepository(context: Context): UserTodoRepository =
        userTodoRepository ?: synchronized(this) {
            userTodoRepository ?: UserTodoRepository(
                api = provideReportApiService(context),
            ).also { userTodoRepository = it }
        }
