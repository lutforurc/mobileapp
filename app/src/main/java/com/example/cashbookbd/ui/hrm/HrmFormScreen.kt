...
fun HrmFormScreen(
    ...
    when (hrmKey) {
        ...
        "hrmOvertimeReport" -> OvertimeMatrixScreen(navController, onLogout, modifier)
        "hrmHolidayCalendar" -> HolidayCalendarScreen(navController, onLogout, modifier)
        "hrmBranchAttendance" -> BranchAttendanceScreen(navController, onLogout, modifier)
