...
/**
 * Adds a brand (manufacturer) — a port of the web's "New Brand" form:
 * Brand Name, Address and Contact required, Email optional.
 */
@Composable
fun AddBrandScreen(
    ...
    viewModel: AddBrandViewModel = viewModel(
        factory = AddBrandViewModel.provideFactory(LocalContext.current)
    ),
) {
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                AppTextField(
                    ...
                    onValueChange = viewModel::onContacts,
                    label = "Enter contact",
                    caption = "Contact",
                ...
                if (!state.canSave) {
                    Text(
                        text = "Brand Name, Address and Contact are required.",
